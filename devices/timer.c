...
/* Comparison function for inserting elements in sleep_list */
static bool sleep_less (const struct list_elem *, const struct list_elem *,
            void *);

/* Check the sleep_list to see if a thread should be woken up */
void check_sleep_threads (void);
            ...
            void *aux UNUSED)
{
  ...
  return a->sleepytime < b->sleepytime;
}
...
/* Check if thread at the top of sleep_list should wake up, used
    in timer_interrupt */
void
